...
COPY /etc/letsencrypt/archive/bot.myshortreport.com/privkey1.pem ./
COPY /etc/letsencrypt/archive/bot.myshortreport.com/fullchain1.pem ./
COPY /etc/letsencrypt/archive/bot.myshortreport.com/cert1.pem ./
...
ENV PRIVATE_KEY "./privkey1.pem"
ENV FULL_CHAIN "./fullchain1.pem"
ENV CERT "./cert1.pem"
